...
use Phpblog\Controller\HomeController;
use Phpblog\Box\Container;
use Phpblog\Box\ModelsFactorie;
use Phpblog\Box\DBDriverSingle;
use Phpblog\Box\UserSingle;
...
class Application
{
    ...
    public function run()
    {
        ...
        $controller = sprintf('Phpblog\Controller\%sController', $controller);
